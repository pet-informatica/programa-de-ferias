...
const NavBarMobile = ({
  ...
  <Sidebar.Pushable>
    <Sidebar
      ...
      visible={visible}
    >
			<Menu.Item content='Inscrições'><Link hash to="#inscricoes">Inscrições</Link></Menu.Item>
  ...
  <Menu fixed="top">
    <Container>
        ...
        <Menu.Menu position="right">
            <Menu.Item disabled content='Inscrições'><Link hash to="#inscricoes">Inscricões</Link></Menu.Item>
						<Menu.Item content='Sobre' ><Link hash to="#sobre">Sobre</Link></Menu.Item>
