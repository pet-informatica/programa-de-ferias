...
export default class Home extends Component{
    render(){
        return(
            <div id="inscricoes" style={{marginTop:'-10px'}}>
                <Image style={{zIndex:'-10'}} src="http://res.cloudinary.com/dkbuneg9h/image/upload/v1511745793/background-img-2_mokgdf_tkq3zv.jpg"/>
                <div id="sobre" style={{textAlign:"center"}}><Button style={{marginTop:'-50px'}} size="massive" href="https://www.sympla.com.br/curso-de-ferias---programacao-em-python__226389" primary>INSCREVA-SE!</Button></div>
